...
class Client:
	...
	def sendRtspRequest(self, requestCode):
		...
		if requestCode == self.SETUP and self.state == self.INIT:
			...
			request = f"{self.SETUP} {self.fileName} {self.RTSP_VER}"
			request += f"\nCSeq: {self.rtspSeq}"
		...
		# Play request
			...
			# Write the RTSP request to be sent.
			request = f"{self.PLAY} {self.fileName} {self.RTSP_VER}"
			request += f"\nCSeq: {self.rtspSeq}"
		...
		# Pause request
			...
			# Write the RTSP request to be sent.
			request = f"{self.PAUSE} {self.fileName} {self.RTSP_VER}"
			request += f"\nCSeq: {self.rtspSeq}"
			request += f"\nSession: {self.sessionId}"
		...
		# Teardown request
			...
			# Write the RTSP request to be sent.
			request = f"{self.TEARDOWN} {self.fileName} {self.RTSP_VER}"
			request += f"\nCSeq: {self.rtspSeq}"
			request += f"\nSession: {self.sessionId}"
